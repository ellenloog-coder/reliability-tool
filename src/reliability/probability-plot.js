...
export function weibullProbabilityPlotFromDataSvg(
  ...
  return `<svg viewBox="0 0 ${width} ${height}" role="img" aria-label="${escapeHtml(labels.probPlot || "Weibull Probability Plot")}">
    <style>.axis{stroke:#98a2b3}.grid{stroke:#e4e7ec}.fit{fill:none;stroke:#2563eb;stroke-width:2.4}.fail{fill:#b42318}.cens-fill{fill:#3538cd;stroke:#3538cd}.rug{stroke:#3538cd;stroke-width:1.5}.mission{stroke:#0f766e;stroke-dasharray:5 5}.point{fill:#0f766e}text{font-family:"PingFang SC","Hiragino Sans GB","Microsoft YaHei","Noto Sans CJK SC","Noto Sans SC",-apple-system,BlinkMacSystemFont,Segoe UI,Arial,sans-serif;fill:#475467}.tick-label{font-size:${RESULT_CHART_TYPE.axisFontSize}px;font-weight:400}.axis-title{font-size:${RESULT_CHART_TYPE.axisFontSize}px;font-weight:500}.legend-text{font-size:${RESULT_CHART_TYPE.legendFontSize}px;font-weight:600}.legend-line{stroke:#2563eb;stroke-width:1.8}</style>
